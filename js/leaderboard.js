...
const accolades = [
    "Novice", "Expert", "Master", "Oga for Chess"
]
...
function setLeaderboard(arr){
    ...
    arr.forEach(element => {
        ...
        var dataValueName = [
        element.rank, element.username, element.points? element.points:0, element.matches? element.matches:0, 
        element.title, element.win? element.win:0, element.draw? element.draw:0, element.loss? element.loss:0
        ]
